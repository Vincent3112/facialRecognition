...
export declare class PdfSidebarContentComponent implements OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PdfSidebarContentComponent, "pdf-sidebar-content", never, { "customThumbnail": "customThumbnail"; }, { "thumbnailDrawn": "thumbnailDrawn"; }, never, ["*"]>;
}
